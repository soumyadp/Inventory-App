...
public class EditorActivity extends AppCompatActivity implements
    ...
    private void display(int number) {
        EditText quantityTextView = (EditText) findViewById(R.id.inventory_item_current_quantity_edittext);
        quantityTextView.setText(number);
    }

    public void incrementQuantity() {

        int quantity = Integer.parseInt(mProductInventory.getText().toString());
        quantity = quantity + 1;
        mProductInventory.setText("" + quantity);
    }
    ...
    public void decrementQuantity() {
        ...
        if (quantity > 0) {
            ...
            Toast.makeText(getApplicationContext(), "Stock already at minimum", Toast.LENGTH_SHORT).show();
    }
    ...
    private void saveProduct() {
        ...
        if (TextUtils.isEmpty(nameString)
                ...
                || TextUtils.isEmpty(mCurrentPhotoUri)) {
        ...
        values.put(InventoryEntry.QUANTITY, inventoryString);
        values.put(InventoryEntry.ITEMS_SOLD_COUNT, salesString);
        values.put(InventoryEntry.PRICE, priceString);
        values.put(InventoryEntry.VENDOR, supplierString);
        values.put(InventoryEntry.IMAGE, mCurrentPhotoUri);
